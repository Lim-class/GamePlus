...
// New Multiplayer and Difficulty elements
...
let gameMode = 'player-vs-player'; // Default mode ('player-vs-player', 'player-vs-ai', 'online')
let scores = { X: 0, O: 0, draws: 0 };
let gameHistory = []; 

// Online Multiplayer state
let onlineGameId = null;
let myRole = null; // 'X' o 'O'
let unsubscribeOnline = null; // Listener di Firebase
