...
const boardSpaces = {
    ...
    2: { name: "Via Atenea (Sù)", price: 180, rent: [14, 70, 200, 550, 750, 950], housePrice: 100, type: "property", group: "rosso", owner: null, houses: 0, mortgaged: false },
    4: { name: "Via Atenea (Giù)", price: 180, rent: [14, 70, 200, 550, 750, 950], housePrice: 100, type: "property", group: "rosso", owner: null, houses: 0, mortgaged: false },
    5: { name: "Stazione C.", price: 200, rent: [25, 50, 100, 200], type: "transport", group: "stazioni", owner: null, mortgaged: false },
    ...
    8: { name: "ENEL Luce", price: 150, type: "utility", group: "utenze", owner: null, mortgaged: false },
    ...
    15: { name: "Bus T.U.A.", price: 200, rent: [25, 50, 100, 200], type: "transport", group: "stazioni", owner: null, mortgaged: false },
    16: { name: "Museo Arch.", price: 150, rent: [25, 50], type: "special", owner: null, mortgaged: false },
    ...
    23: { name: "Viale Vittoria", price: 350, rent: [35, 175, 500, 1100, 1300, 1500], housePrice: 200, type: "property", group: "viola", owner: null, houses: 0, mortgaged: false },
    24: { name: "Valle Templi", price: 200, rent: [50, 100], type: "special", owner: null, mortgaged: false },
    25: { name: "Rotatoria Scrittori", price: 200, rent: [25, 50, 100, 200], type: "transport", group: "stazioni", owner: null, mortgaged: false },
    ...
    32: { name: "A.I.C.A.", price: 150, type: "utility", group: "utenze", owner: null, mortgaged: false },
    33: { name: "Giardina G.", price: 260, rent: [22, 110, 330, 800, 975, 1150], housePrice: 150, type: "property", group: "giallo", owner: null, houses: 0, mortgaged: false },
    ...
    35: { name: "Viadotto Akragas", price: 200, rent: [25, 50, 100, 200], type: "transport", group: "stazioni", owner: null, mortgaged: false },
    36: { name: "Il Duomo", price: 240, rent: [20, 100, 300, 750, 925, 1100], housePrice: 150, type: "property", group: "rosa", owner: null, houses: 0, mortgaged: false },
    37: { name: "Santa Croce", price: 220, rent: [18, 90, 250, 700, 875, 1050], housePrice: 150, type: "property", group: "rosa", owner: null, houses: 0, mortgaged: false },
    39: { name: "Il Rabato", price: 220, rent: [18, 90, 250, 700, 875, 1050], housePrice: 150, type: "property", group: "rosa", owner: null, houses: 0, mortgaged: false }
};